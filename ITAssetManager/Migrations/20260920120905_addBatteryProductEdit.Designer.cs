...
namespace ITAssetManager.Migrations
{
    ...
    [Migration("20260920120905_addBatteryProductEdit")]
    partial class addBatteryProductEdit
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ITAssetManager.Models.BatteryConsumption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ITAssetManager.Models.BatteryConsumption", b =>
                {
                    ...
                    b.HasOne("ITAssetManager.Models.Asset", "UPS")
                        .WithMany()
                        .HasForeignKey("UPS_Id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("ITAssetManager.Models.CartridgeConsumption", b =>
                {
                    b.HasOne("ITAssetManager.Models.Asset", "Printer")
                        .WithMany()
